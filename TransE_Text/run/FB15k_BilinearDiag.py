...
savepath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/TransE_Text/outputs/FB15k_BilinearDiag/'
...
launch(experiment_type = 'FB15kexp', op='BilinearDiag', simfn= simfn, ndim= ndim, \
