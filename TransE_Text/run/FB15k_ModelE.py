...
savepath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/TransE_Text/outputs/FB15k_ModelE/'
datapath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/TransE_Text/data/'

identifier = 'ModelE_' + str(simfn) + '_ndim_' + str(ndim) \
...
launch(experiment_type = 'FB15kexp', op='ModelE', simfn= simfn, ndim= ndim, \
