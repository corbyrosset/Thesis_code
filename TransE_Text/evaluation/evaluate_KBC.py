...
### apparently not used?
def RankingEvalFil(datapath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/TransE_Text/data/', dataset='FB15k', op='TransE',
        loadmodel='best_valid_model.pkl', fold=0, Nrel=14951, Nsyn=1345):
