...
simfn = 'Dot' ### cannot change this for Bilinear
...
savepath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/KBC_Text/outputs/FB15k_Bilinear/'
datapath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/KBC_Text/data/'

identifier = 'Bilinear_' + str(simfn) + '_ndim_' + str(ndim) \
...
launch(identifier, experiment_type, logger, op='Bilinear', \
