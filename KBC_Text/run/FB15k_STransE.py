...
reg = 0.05       #{0.01, 0.1} if None, no regularization (= 0.0)
...
savepath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/KBC_Text/outputs/FB15k_STransE/'
datapath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/KBC_Text/data/'

identifier = 'STransE_' + str(simfn) + '_ndim_' + str(ndim) \
