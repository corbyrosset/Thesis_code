...
savepath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/KBC_Text/outputs/FB15k_DoubleLinear/'
datapath='/Users/corbinrosset/Dropbox/Arora/QA-code/src/KBC_Text/data/'

identifier = 'DoubleLinear_' + str(simfn) + '_ndim_' + str(ndim) \
...
launch(identifier, experiment_type, logger, op='DoubleLinear', \
